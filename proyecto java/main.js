const productos=[
    {
    id:1 , 
    nombre: "Smart TV 4K UHD Samsung 55", 
    Precio: 1000},
    {
    id: 2, 
    nombre: "Smart TV Philips 43", 
    Precio: 20051},
    {
    id: 3 ,
    nombre: "Smart TV Philips 32", 
    Precio: 32516},
    {
    id:4 , 
    nombre: "Smart TV 40 TCL", 
    Precio: 25154},
    {
    id:5 , 
    nombre: "Smart TV 4K 65", 
    Precio: 56168},
    {
    id: 6, 
    nombre: "Smart TV LED 50 4K UHD RCA", 
    Precio: 32656},
    {
    id: 7 , 
    nombre: "Celular Motorola G42 128GB Rosa Metálico", 
    Precio: 21544},
    {
    id: 8 , 
    nombre: "Celular Samsung Galaxy A53 5G 128GB Negro", 
    Precio: 25474},
    {
    id: 9 , 
    nombre: "Xiaomi Redmi Note 11 128GB Negro", 
    Precio: 12543},
    {
    id: 10, 
    nombre: "Celular Samsung Galaxy A04e 32GB Black", 
    Precio: 35654},
    {
    id: 11 , 
    nombre: "Notebook Exo R33 14", 
    Precio: 65651},
    {
    id:12, 
    nombre: "Notebook Tecnobrand", 
    Precio: 45654},
    {
    id:13,
    ...
    {
    id: 14, 
    nombre: "Reloj Inteligente Mujer Smartwatch Nictom NT14", 
    Precio: 7532},
    {
    id: 15 , 
    nombre: "Impresora Multifunción HP DeskJet Ink Advantage 2375", 
    Precio: 2465},
    {
    id:16, 
    nombre: "Auriculares High Electric TWS", 
    Precio: 1000},
    ];
    ...
    productos.forEach(producto => {
        let cardProductos = document.createElement('article');
        cardProductos.innerHTML =
            `<div>
            <h2>Nombre:${producto.nombre}</h2>
            <b>Precio:${producto.Precio}</p>
